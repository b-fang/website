...
bebobot is a discord bot that current tracks the rank of summoner b3b0 (me) in both ranked solo/duo and tft. The purpose of this bot is rather meaningless,
...
variety of analytical purposes. Overall, the main purpose of this project is to outline the following:
 ...
 - Work with discord bots and the Discord API as well because it's fun!
...
A natural extension for this project would be to plot LP over time and add it as a field to the embeded Discord Message or allow the discord command to specify the summoner. These would require 
