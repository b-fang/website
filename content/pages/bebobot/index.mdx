...
Additionally, the RiotWatcher library was used out of convenience. More info about [RiotWatcher](https://riot-watcher.readthedocs.io/en/latest/) can be found here.
