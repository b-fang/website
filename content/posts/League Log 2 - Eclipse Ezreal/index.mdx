...
![Wink](https://media.tenor.com/MJKEzySQ_esAAAAC/ezreal-the-prodigal-explorer.gif)
...
inventive builds. This especially comes to light in two main criteria:
 - In Game Feel
...
final item ravenous isn't possible (needing maw for an akali for example).

When talking about items, I want to break down just how much more damage you will be able to do with Eclipse with First Strike 
in comparison to Triforce with Conqueror or PtA.
